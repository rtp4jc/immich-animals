...
from dog_id.keypoint.dataset_converter import CocoKeypointDatasetConverter, create_default_config
from dog_id.keypoint.yolo_converter import CocoToYoloKeypointConverter, create_default_converter


def main():
    """Main execution function."""
    parser = argparse.ArgumentParser(description="Prepare keypoint dataset")
    parser.add_argument("--output-dir", default="data/keypoints/coco", 
                       help="Output directory for COCO dataset")
    parser.add_argument("--yaml-path", default="data/keypoints/dogs_keypoints_only.yaml",
