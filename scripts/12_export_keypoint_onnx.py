...
def main():
    ...
    if not latest_run_dir:
        print(
            f"[ERROR] No training runs found for '{KEYPOINT_RUN_NAME}' in '{KEYPOINT_PROJECT_DIR}'."
        )
        sys.exit(1)
    ...
    if not model_checkpoint.exists():
        ...
        print(
            "Please ensure that the keypoint model has been trained and the path is correct."
        )
        sys.exit(1)
