...
1. Improve baseline and tracking: the current model doesn't have terrible metrics, but I need to do a full re-run of the training to ensure I have models with the best training results. I need to be dilligent and output these metrics to W&B so I have a baseline. Once I have this, I need to create a master script to do the full training run without any internvention from me so I can see the effect of any fixes I might make in data preparation.
