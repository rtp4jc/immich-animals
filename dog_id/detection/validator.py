...
class DetectionValidator:
    ...
    def validate_model(self, data_yaml: str = "data/detector/dogs_detection.yaml") -> Tuple[YOLO, Dict[str, float]]:
    ...
    def run_inference(self, image_paths: list, output_dir: str = "outputs/detection_inference", 
...
def validate_latest_detector(data_yaml: str = "data/detector/dogs_detection.yaml") -> Tuple[YOLO, Dict[str, float]]:
