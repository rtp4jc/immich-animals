...
class IdentityLoader:
    ...
    def load_validation_data(self, 
                           ...
                           max_per_identity: Optional[int] = None) -> List[Dict[str, str]]:
        """
    ...
    def _limit_per_identity(self, data: List[Dict[str, str]], max_per_identity: int) -> List[Dict[str, str]]:
    ...
    def _create_augmented_dataset(self,
                                ...
                                max_per_identity: Optional[int]) -> List[Dict[str, str]]:
        """Create augmented dataset prioritizing additional identities."""
        ...
        for item in base_data:
            ...
            if identity not in used_identities:
                if max_per_identity is None or identity_counts[identity] < max_per_identity:
